// ฟังชั้นเกดโปดักเเสดงโปดักจากมอกapi โค้ด Js ผมไม่ค่อยเข้าใจมากเลยเอาบางส่วนมาจากโปรเเจคเพื่อให้มันออกมาเห็นเป็นรูปเป็นร่างคับ
const getProduct = async () => {
    try {
        const response = await axios.get(
            "https://6102d7aa79ed680017482359.mockapi.io/productlist"
        );
        // getElementProductCard เเมพ Product ตามด้านล่าง
        document.getElementById("allProductCard").innerHTML = response.data
            ...
            `
                     // เเต่ละ ProductCard มี รูป ราคา ไอดี
            )
            .join("");
    } catch (e) {
        console.log(`e`, e);
...
//   จะออกมาตามด้านล่างjoin product เข้าต่อกัน
